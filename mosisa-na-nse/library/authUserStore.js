...
const secureStorage = {
  getItem: async (name) => {
    ...
    try {
      // ✅ Add a timeout for iOS reliability
      ...
      console.log(`[secureStorage] Retrieved ${name}:`, result ? 'found' : 'not found');
      return result;
    } catch (error) {
      console.error('[SecureStore] getItem error:', error.message);
  ...
  setItem: async (name, value) => {
    ...
    try {
      ...
      console.log(`[secureStorage] Stored ${name}`);
    } catch (error) {
      console.error('[SecureStore] setItem error:', error.message);
    }
  },
  ...
  removeItem: async (name) => {
    ...
    try {
      ...
      console.log(`[secureStorage] Deleted ${name}`);
    } catch (error) {
      console.error('[SecureStore] removeItem error:', error.message);
    }
  },
};
